...
public class Java2word {
	...
	public static void main(String[] args) {
         ...
         data.put("$date1$","2007-8-1");
         data.put("$time1$","2007-8-2");
         data.put("$indexprovince1$","kdl");
         data.put("$mainpercentage1$","5号线");
         data.put("$start1$","11月13日");
         data.put("$end1$","2004年11月10日");
         data.put("$image1$","D:\\1.png");
         data.put("$namelist1$", "FishRoad");
         //替换word中表格的数据
         /**
         ...
         j2w.toWord("D:/test.docx","D:/result.doc",data);
