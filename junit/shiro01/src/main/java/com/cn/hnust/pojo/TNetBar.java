...
public class TNetBar implements Serializable{
	private static final long serialVersionUID = 7611319057980690557L;
	...
	public String toString() {
		return "TNetBar [id=" + id + ", mainId=" + mainId + ", netbarName=" + netbarName + ", netbarState="
				+ netbarState + ", districtCode=" + districtCode + ", regAddress=" + regAddress + ", regAddressDetail="
				+ regAddressDetail + ", regFund=" + regFund + ", economicType=" + economicType + ", approvalNum="
				+ approvalNum + ", approvalDept=" + approvalDept + ", approvalDate=" + approvalDate + ", legalName="
				+ legalName + ", busiArea=" + busiArea + ", computerNum=" + computerNum + ", ip=" + ip + ", isdeleted="
				+ isdeleted + ", updateTime=" + updateTime + ", contactName=" + contactName + ", contactTel="
				+ contactTel + ", cityCode=" + cityCode + ", isdeployed=" + isdeployed + ", createTime=" + createTime
				+ ", syncTime=" + syncTime + ", clientVersion=" + clientVersion + ", serverVersion=" + serverVersion
				+ "]";
	}
